...
const SideBar = () => {
  ...
  useEffect(() => {
    // menuList.map((x) => {
    //   if (x.link === routeLocation.pathname) {
    //     setSelectedKeys(JSON.stringify(x.id));
    //   }
    //   if (x.SubMenu) {
    //     x.SubMenuItems.map((z) => {
    //       if (z.link === routeLocation.pathname) {
    //         setSelectedKeys(JSON.stringify(z.id));
    //         setSubMenuOpen(JSON.stringify(x.id));
    //       }
    //     });
    //   }
    // });
